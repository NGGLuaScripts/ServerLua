    ...
    for i = 0, maxPlayers - 1 do
        ...
        if car and car.isConnected and driverName and driverName ~= "" then
            ...
            if driftScore > 0 then
                ...
                -- Her oyuncunun kişisel en iyi skorunu kontrol et ve güncelle
                if not personalBestScores[driverName] then
                    personalBestScores[driverName] = 0
                end
                
                if playerDriftScores[driverName] > personalBestScores[driverName] then
                    personalBestScores[driverName] = math.floor(playerDriftScores[driverName])
                end
            end
            
            -- Eğer oyuncu yoldan çıktıysa veya çarptıysa skorunu sıfırla
